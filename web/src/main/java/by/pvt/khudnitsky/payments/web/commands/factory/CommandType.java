...
import by.pvt.khudnitsky.payments.web.commands.admin.ShowOperationsCommand;
import by.pvt.khudnitsky.payments.web.commands.admin.UnblockCommand;
import by.pvt.khudnitsky.payments.web.commands.client.AddFundsCommand;
import by.pvt.khudnitsky.payments.web.commands.client.BalanceCommand;
import by.pvt.khudnitsky.payments.web.commands.client.BlockCommand;
import by.pvt.khudnitsky.payments.web.commands.client.GoBackClientCommand;
import by.pvt.khudnitsky.payments.web.commands.client.GoToAddFundsCommand;
import by.pvt.khudnitsky.payments.web.commands.client.GoToPaymentCommand;
import by.pvt.khudnitsky.payments.web.commands.client.PaymentCommand;
import by.pvt.khudnitsky.payments.web.commands.user.GoBackCommand;
import by.pvt.khudnitsky.payments.web.commands.user.GoToRegistrationCommand;
import by.pvt.khudnitsky.payments.web.commands.user.LoginUserCommand;
import by.pvt.khudnitsky.payments.web.commands.user.LogoutUserCommand;
import by.pvt.khudnitsky.payments.web.commands.user.RegistrationCommand;
