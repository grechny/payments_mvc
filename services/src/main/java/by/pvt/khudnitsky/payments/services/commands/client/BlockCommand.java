 ...
 */
package by.pvt.khudnitsky.payments.services.commands.client;
...
import by.pvt.khudnitsky.payments.services.commands.factory.CommandType;
...
public class BlockCommand extends AbstractCommand {
    ...
    private void blockAccount(Connection connection, int aid) throws SQLException{
        ...
        AccountDao.INSTANCE.updateAccountStatus(connection, aid, AccountStatuses.BLOCK);
    }
}
